...
public class Magazine extends Item{
	 ...
	 */
	public Magazine(String name, String type, String id, int libraryCode, int uniqueQuantityID){
	 ...
	 */
	public Magazine(String name, String type, String id, String volume, int libraryCode, int uniqueQuantityID){
		libraryID = libraryCode;
		this.volume = volume;
		item_name = name;
		item_type = type;
	...
	public Magazine(String type, String id, String name, String volume, int libraryCode, boolean fromXML, int uniqueQuantityID){
		libraryID = libraryCode;
		this.volume = volume;
		item_name = name;
		item_type = type;
