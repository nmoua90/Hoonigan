...
public class DVD extends Item{
	 ...
	 * @param id - id of DVD
	 */
	public DVD(String name, String type, String id, int libraryCode, int uniqueQuantityID){
		item_name = name;
		item_type = type;
		item_id = id;
		checkedOut = false;
	...
	public DVD(String type, String id, String name, int libraryCode, boolean fromXML, int uniqueQuantityID){
		item_name = name;
		item_type = type;
		item_id = id;
		checkedOut = false;
	...
	public String toString(){
		String line = String.format("ID: %s | TITLE: %s | TYPE: %s | STATUS: %s | LIBRARY ID: %d | Unique ID: %d", 
				item_id, item_name, item_type, status(), libraryID, uniqueQuantityID);
		return line;
	}
}
