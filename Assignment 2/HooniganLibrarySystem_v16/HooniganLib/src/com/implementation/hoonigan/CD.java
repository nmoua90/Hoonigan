...
public class CD extends Item{
	 ...
	 */
	 public CD(String name, String type, String id, String artist, int libraryCode, int uniqueQuantityID){
		item_name = name;
		item_type = type;
		item_id = id;
		item_artist = artist;
	 ...
	 public CD(String type, String id, String artist, String name, int libraryCode, boolean fromXML, int uniqueQuantityID){
		item_name = name;
		item_type = type;
		item_id = id;
		item_artist = artist;
	...
	public String toString(){
		String line = String.format("ID: %s | TITLE: %s | TYPE: %s | ARTIST: %s | STATUS: %s | LIBRARY ID: %d | UNIQUE ID: %d", 
				item_id, item_name, item_type, item_artist, status(), libraryID, uniqueQuantityID);
		return line;
	}
}