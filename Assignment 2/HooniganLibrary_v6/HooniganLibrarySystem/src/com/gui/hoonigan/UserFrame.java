...
public class UserFrame{
	 ...
	 * Create the frame.
	 */
	public UserFrame(String currentUser) { ///Change parameter -> User currentUser in Final Implementation
		...
		btnCheckIn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				CheckInFrame checkInScreen = new CheckInFrame(currentUser);
		...
		btnCheckOut.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				//If the user doesn't owe any fees, let them go to the next screen
					CheckOutFrame enterLibrary = new CheckOutFrame(currentUser);
