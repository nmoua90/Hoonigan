...
public class JsonParser {	
	...
	private Multimap<String, Item> libraryMap;
	...
	public JsonParser(BufferedReader br, int libraryID){
		...
		this.libraryMap = ArrayListMultimap.create();
	 ...
	 */
	public Multimap<String, Item> getLibraryMap(){
	 ...
	 */
	public void setlibraryMap(Multimap<String, Item> li){
		this.libraryMap = li;
	}
