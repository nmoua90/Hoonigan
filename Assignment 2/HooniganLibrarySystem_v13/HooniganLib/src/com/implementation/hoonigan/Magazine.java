...
public class Magazine extends Item{
	...
	public Magazine(String type, String id, String name, String volume, int libraryCode, boolean fromXML){
		libraryID = libraryCode;
		this.volume = volume;
		item_name = name;
		item_type = type;
	...
	public String toString(){
		String line = String.format("ID: %s | TITLE: %s | TYPE: %s | STATUS: %s | VOLUME: %s | LIBRARY ID: %d", 
				item_id, item_name, item_type, status(), volume, libraryID);
		return line;
	}
}
