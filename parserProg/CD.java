...
public class CD extends Library_Items{
    ...
    /**CD(String type, String id, String artist, String name, boolean sisterLibrary)
     * Constructor which instantiates a CD object from XML parser
     * @param type
     * @param id
     * @param artist
     * @param name
    ...
    public String toString(){
        String line = String.format("ID: %s | TITLE: %s | TYPE: %s | ARTIST: %s | STATUS: %s | LOCATION: %s",
                item_id, item_name, item_type, item_artist, status(), location());
        return line;
    }
}